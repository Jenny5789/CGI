...
if use_fp16:
    # UNet + ControlNet declare use_fp16 in anydoor.yaml (internal x.type(self.dtype)
    # casting), so their weights can safely live in fp16. DINOv2 (cond_stage) and the
    # VAE (first_stage) stay fp32 for stability.
